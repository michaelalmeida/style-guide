...
import { Typography, Col, Empty, Button, Card, Tag, Tabs, Input, Checkbox, Radio, Switch } from 'antd';
    ...
    switch(element) {
        ...
        case 'Form':
           ...
           <Col span={18}>
                    ...
                    <Text style={{display: 'block', margin: '25px 0 10px 0'}}>Checkbox</Text>
                    <Checkbox>A</Checkbox> 
                    <Checkbox>B</Checkbox>
                    <Text style={{display: 'block', margin: '25px 0 10px 0'}}>Radio</Text>
                    <Radio.Group>
                    ...
                    <Text style={{display: 'block', margin: '25px 0 10px 0'}}>Switch</Text>
